                        ...
                        <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                <div class="row-start-1 grid grid-flow-col gap-y-10 gap-x-8 text-sm">
                                    <div>
                                        <p id="style-heading" class="font-medium text-gray-900">Estilo</p>
                                        <ul role="list" aria-labelledby="Clothing-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Kodomo</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Shounem</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Shoujo</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Hentai (Seijin)</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Ecchi</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Yaoi</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Yuri</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Gekigá</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p id="style-heading" class="font-medium text-gray-900">-</p>
                                        <ul role="list" aria-labelledby="Clothing-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Seinen</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Josei</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Doujinshi</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">One Shot</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Isekai</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Slice of Life</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Sci-fi</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Harém</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p id="genre-heading" class="font-medium text-gray-900">Genero</p>
                                        <ul role="list" aria-labelledby="Accessories-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Ação</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Artes Marciais</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Aventura</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Culinária</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Drama</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Fantasia</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Esporte</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Suspense</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        ...
                                        <ul role="list" aria-labelledby="Clothing-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Horror</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Sobrenatural</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Sobrevivência</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Tragédia</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Romance</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Mistério</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Psicológico</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Medieval</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p id="type-heading" class="font-medium text-gray-900">-</p>
                                        <ul role="list" aria-labelledby="Brands-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Comédia</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <p id="type-heading" class="font-medium text-gray-900">Tipo</p>
                                        <ul role="list" aria-labelledby="Brands-heading"
                                            class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Novel</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Mangá</a>
                                            </li>
                                            <li class="flex">
                                                <a href="#" class="hover:text-gray-800">Manhua</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
